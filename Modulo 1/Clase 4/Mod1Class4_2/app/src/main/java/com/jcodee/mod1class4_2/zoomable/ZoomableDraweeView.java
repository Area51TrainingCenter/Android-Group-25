...
package com.jcodee.mod1class4_2.zoomable;
...
public class ZoomableDraweeView extends DraweeView<GenericDraweeHierarchy> implements ZoomableController.Listener {
    ...
    private ZoomableController mZoomableController = DoubleTapZoomableController.newInstance(getContext());
